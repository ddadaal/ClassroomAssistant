...
将**服务器**分解为**考试模块、讨论模块、举手模块、签到模块、下载模块、上传模块、消息推送模块、网络模块、权限模块、数据库模块**，除权限模块与数据库模块，**客户端**与服务器保持一致，故在后续分解中只分解服务器
...
![](cs/cjy/img/举手_cc.png) 

**模块视图**

![](cs/cjy/img/举手_model.png) 
...
![](cs/cjy/img/讨论_cc.png) 

**模块视图**

![](cs/cjy/img/讨论_model.png) 
...
![](cs/cjy/img/网络_cc.png) 

**模块视图**

![](cs/cjy/img/网络_model.png) 
...
![](cs/ljd/img/cmp-sign.svg)

**模块视图**

![](cs/ljd/img/pkd-sign.svg)
...
![](cs/ljd/img/cmp-data.svg)

**模块视图**

![](cs/ljd/img/pkg-data.svg)
